...
export default class SendUserActivationEmailUseCase
  implements
    IUseCase<
    ...
    >
{
  ...
  async run(
    input: SendUserActivationEmailUseCaseInput,
  ): Promise<SendUserActivationEmailUseCaseOutput> {
  ...
  private async createActivationRequestRegister(
    user: User,
  ...
  private async sendActivationRequestEmail(
