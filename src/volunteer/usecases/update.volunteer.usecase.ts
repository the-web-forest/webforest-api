...
export default class UpdateVolunteerUseCase implements IUseCase<UpdateVolunteerUseCaseInput, UpdateVolunteerUseCaseOutput> {
    ...
    async run(input: UpdateVolunteerUseCaseInput): Promise<UpdateVolunteerUseCaseOutput> {
